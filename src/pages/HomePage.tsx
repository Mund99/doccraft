  ...
  return (
    <DocLayout>
      ...
      <DocTable
        ...
        rows={[
          ['Light & dark theme', 'Warm white / earthy neutral — toggle persists via localStorage'],
          ['Responsive sidebar', 'Collapsible sections, auto-closes on mobile resize'],
          ['On-page TOC', 'Right-side table of contents with active section tracking'],
          ...
          ['Mermaid diagrams', 'Inline flowcharts via the Diagram component'],
  ...
  return (
    <DocLayout>
      ...
      <div className="file-tree">
        ...
        <span className="note">  ← title, logo, github, version</span>{'\n'}
